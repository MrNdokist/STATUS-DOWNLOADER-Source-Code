...
import com.mrndokist.app.saverstatus.base.BaseActivity;
import com.mrndokist.app.saverstatus.tabs.ImagesFragment;
import com.mrndokist.app.saverstatus.tabs.VideoFragment;
   ...
   private  class a extends FragmentPagerAdapter {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_help) {
            //aboutMoreApps();
            TabsActivity.this.startActivity(new Intent("android.intent.action.VIEW",
                    Uri.parse(TabsActivity.this.getString(R.string.play_more_apps))));
            return true;
        }
    ...
    private void aboutDialog() {
        ...
        ((TextView) localDialog.findViewById(R.id.msg)).setTypeface(localTypeface2);
        ((TextView) localDialog.findViewById(R.id.name)).setTypeface(localTypeface1);
    ...
    public void createShortCut() {
        ...
        shortcutintent.putExtra(Intent.EXTRA_SHORTCUT_INTENT, new Intent(getApplicationContext(), TabsActivity.class));
